...
do
  ...
  local function AutoUpdate()
    ...
    if NewVersion > Version then
	  ...
	  print("Pls Download PussySprites Folder new !!!!!")
    else
...
function OnLoad()
  ...
  pathChamp = os.getenv("APPDATA").."\\GamingOnSteroids\\LOLEXT\\Sprites\\PussySprites\\"
  ...
  DelayAction(function()
    for i = 1, Game.HeroCount() do
      ...
      if hero and hero.isEnemy and eT[hero.networkID] == nil then
        ...
        if fileFound(pathChamp.."PussySprites\\Champions\\"..hero.charName..".png") then
          ...
          print ("File not exist:"..pathChamp..". Add default image, please check updates in forum. ")
          champSprite[hero.charName] = Sprite("PussySprites\\Champions\\x.png", 1.2)
          champSpriteSmall[hero.charName] = Sprite("PussySprites\\Champions\\x.png", 1)
          champSpriteMini[hero.charName] = Sprite("PussySprites\\Champions\\x.png", .5)
          champSpriteMiniC[hero.charName] = Sprite("PussySprites\\Champions\\x.png", .5)
        end
