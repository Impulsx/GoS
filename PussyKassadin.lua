...
function Kassadin:KillSteal()
	...
	if target and not target.dead then
		local Target, aimPosition = HPred:GetUnreliableTarget(myHero.pos, Q.range, Q.delay, Q.speed, Q.radius, Q.Collision, 1, nil)
		if Target and self.Menu.ks.UseQ:Value() and Ready(_Q) then
		...
		local Target, aimPosition = HPred:GetUnreliableTarget(myHero.pos, Q.range, Q.delay, Q.speed, Q.radius, Q.Collision, 1, nil)		
		if Target and self.Menu.ks.UseQR:Value() and Ready(_R) and Ready(_Q) and not IsUnderTurret(target) then
		...
		local Target, aimPosition = HPred:GetUnreliableTarget(myHero.pos, Q.range, Q.delay, Q.speed, Q.radius, Q.Collision, 1, nil)
		if Target and self.Menu.ks.UseRQ:Value() and Ready(_R) and Ready(_Q) and not IsUnderTurret(target) then
...
function Kassadin:AutoW()  
	...
	if target == nil then return end
	if target and Ready(_W) and myHero.pos:DistanceTo(target.pos) <= 300 then
...
if target == nil then return end
	local Target, aimPosition = HPred:GetUnreliableTarget(myHero.pos, Q.range, Q.delay, Q.speed, Q.radius, Q.Collision, 1, nil)
	if Target and not target.dead and self.Menu.Combo.UseQ:Value() and Ready(_Q) and myHero.pos:DistanceTo(target.pos) < 650 then
		Control.CastSpell(HK_Q, aimPosition)
	end
	if target and not target.dead and self.passiveTracker >= 1 and self.Menu.Combo.UseE:Value() and Ready(_E) and myHero.pos:DistanceTo(target.pos) < 600 then	
...
if target and not target.dead then 
local Target, aimPosition = HPred:GetUnreliableTarget(myHero.pos, Q.range, Q.delay, Q.speed, Q.radius, Q.Collision, 1, nil)
	if Target and Ready(_Q) and self.Menu.Combo.UseQ:Value() then 
	...
	if Target and Ready(_E) and Ready(_Q) and self.Menu.Combo.UseE:Value() and self.Menu.Combo.UseQ:Value() then	
	...
	if Target and Ready(_Q) and Ready(_R) and self.Menu.Combo.UseQ:Value() and self.Menu.Combo.UseR:Value() then	
	...
	if Target and Ready(_E) and Ready(_Q) and Ready(_R) and self.Menu.Combo.UseE:Value() and self.Menu.Combo.UseQ:Value() and self.Menu.Combo.UseR:Value() then	
	...
	if Target and Ready(_E) and Ready(_Q) and Ready(_R) and Ready(_W) and self.Menu.Combo.UseE:Value() and self.Menu.Combo.UseQ:Value() and self.Menu.Combo.UseR:Value() and self.Menu.Combo.UseW:Value() then	
