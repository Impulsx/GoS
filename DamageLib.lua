...
print("PussyDamageLib 11.4 loaded")
...
local DamageLibTable = {
  ...
  ["Samira"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({0, 5, 10, 15, 20})[level] + ({0.8, 0.87, 0.95, 1.02, 1.10})[level] * source.totalDamage end},
