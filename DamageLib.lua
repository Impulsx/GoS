...
local ItemID = { --13.19 update
    ...
    EyeoftheHerald = 1104 and 3513,
    PenetratingBullets = 1500,
    Fortification = 1501 and 1521,
    ReinforcedArmor = 1502 and 1506,
    WardensEye = 1503,
    Vanguard = 1504,
    Overcharged = 1507,
    AntitowerSocks = 1508,
    ...
    TurretPlating = 1515,
    StructureBounty = 1516 and 1517 and 1518 and 1519,
    ...
    GuardiansHorn = 2051 and 222051,
    PoroSnax = 2052,
    ControlWard = 2055,
    ShurelyasBattlesong = 2065 and 222065,
    ElixirofIron = 2138,
    ...
    Stopwatch = 2420,
    BrokenStopwatch = 2421 and 2424,
    SlightlyMagicalFootwear = 2422,
    PerfectlyTimedStopwatch = 2423,
    Evenshroud = 3001 and 223001,
    ArchangelsStaff = 3003 and 223003,
    Manamune = 3004 and 223004,
    BerserkersGreaves = 3006 and 223006,
    BootsofSwiftness = 3009 and 223009,
    ChemtechPutrifier = 3011 and 223011,
    ChaliceofBlessing = 3012,
    SorcerersShoes = 3020 and 223020,
    LifewellPendant = 3023,
    GlacialBuckler = 3024,
    GuardianAngel = 3026,
    InfinityEdge = 3031 and 223026,
    MortalReminder = 3033 and 223031,
    LastWhisper = 3035 and 223033,
    LordDominiksRegards = 3036 and 223036,
    SeraphsEmbrace = 3040 and 223040,
    MejaisSoulstealer = 3041,
    Muramana = 3042 and 223042,
    Phage = 3044,
    PhantomDancer = 3046 and 223046,
    PlatedSteelcaps = 3047 and 223047,
    ZekesConvergence = 3050 and 223050,
    HearthboundAxe = 3051,
    SteraksGage = 3053 and 223053,
    Sheen = 3057,
    SpiritVisage = 3065 and 223065,
    WingedMoonplate = 3066,
    Kindlegem = 3067,
    SunfireAegis = 3068 and 223068,
    TearoftheGoddess = 3070,
    BlackCleaver = 3071 and 223071,
    Bloodthirster = 3072 and 223072,
    RavenousHydra = 3074 and 223074,
    Thornmail = 3075 and 223075,
    BrambleVest = 3076,
    Tiamat = 3077,
    TrinityForce = 3078 and 223078,
    WardensMail = 3082,
    WarmogsArmor = 3083,
    Heartsteel = 3084 and 223084,
    RunaansHurricane = 3085 and 223085,
    Zeal = 3086,
    StatikkShiv = 3087 and 223087,
    RabadonsDeathcap = 3089 and 223089,
    WitsEnd = 3091 and 223091,
    RapidFirecannon = 3094 and 223094,
    Stormrazor = 3095 and 223095,
    LichBane = 3100 and 223100,
    BansheesVeil = 3102 and 223102,
    AegisoftheLegion = 3105,
    Redemption = 3107 and 223107,
    FiendishCodex = 3108,
    KnightsVow = 3109 and 223109,
    FrozenHeart = 3110 and 223110,
    MercurysTreads = 3111 and 223111,
    GuardiansOrb = 3112 and 223112,
    AetherWisp = 3113,
    ForbiddenIdol = 3114,
    NashorsTooth = 3115 and 223115,
    RylaisCrystalScepter = 3116 and 223116,
    MobilityBoots = 3117,
    WintersApproach = 3119 and 223119,
    Fimbulwinter = 3121 and 223121,
    ExecutionersCalling = 3123,
    GuinsoosRageblade = 3124 and 223124,
    DeathfireGrasp = 3128,
    CaulfieldsWarhammer = 3133,
    SerratedDirk = 3134,
    VoidStaff = 3135 and 223135,
    MercurialScimitar = 3139 and 223139,
    QuicksilverSash = 3140,
    YoumuusGhostblade = 3142 and 223142,
    RanduinsOmen = 3143 and 223143,
    HextechAlternator = 3145,
    HextechRocketbelt = 3152 and 223152,
    BladeofTheRuinedKing = 3153 and 223153,
    Hexdrinker = 3155,
    MawofMalmortius = 3156 and 223156,
    ZhonyasHourglass = 3157 and 223157,
    IonianBootsofLucidity = 3158 and 223158,
    SpearOfShojin = 3161 and 223161,
    Morellonomicon = 3165 and 223165,
    GuardiansBlade = 3177 and 223177,
    UmbralGlaive = 3179,
    Hullbreaker = 3181 and 223181,
    GuardiansHammer = 3184 and 223184,
    LocketoftheIronSolari = 3190 and 223190,
    SeekersArmguard = 3191,
    GargoyleStoneplate = 3193 and 223193,
    SpectresCowl = 3211,
    MikaelsBlessing = 3222 and 223222,
    ...
    YourCut = 3400,
    RiteOfRuin = 3430,
    ArdentCenser = 3504 and 223504,
    EssenceReaver = 3508 and 223508,
    KalistasBlackSpear = 3599 and 3600,
    DeadMansPlate = 3742 and 223742,
    TitanicHydra = 3748 and 223748,
    CrystallineBracer = 3801,
    LostChapter = 3802,
    CatalystofAeons = 3803,
    EdgeofNight = 3814 and 223814,
    ...
    RaiseMorale = 3903,
    OblivionOrb = 3916,
    ImperialMandate = 4005 and 224005,
    BloodlettersCurse = 4010,
    ForceofNature = 4401 and 224401,
    TheGoldenSpatula = 4403 and 224403,
    HorizonFocus = 4628 and 224628,
    CosmicDrive = 4629 and 224629,
    BlightingJewel = 4630,
    VerdantBarrier = 4632,
    Riftmaker = 4633 and 224633,
    LeechingLeer = 4635,
    NightHarvester = 4636 and 224636,
    DemonicEmbrace = 4637 and 224637,
    WatchfulWardstone = 4638,
    StirringWardstone = 4641,
    BandleglassMirror = 4642,
    VigilantWardstone = 4643,
    CrownoftheShatteredQueen = 4644 and 224644,
    Shadowflame = 4645 and 224645,
    IronspikeWhip = 6029,
    SilvermereDawn = 6035 and 226035,
    DeathsDance = 6333 and 226333,
    ChempunkChainsword = 6609 and 226609,
    StaffofFlowingWater = 6616 and 226616,
    MoonstoneRenewer = 6617 and 226617,
    EchoesofHelia = 6620 and 226620,
    Goredrinker = 6630 and 226630,
    Stridebreaker = 6631 and 226631,
    DivineSunderer = 6632 and 226632,
    LiandrysAnguish = 6653 and 226653,
    LudensTempest = 6655 and 226655,
    Everfrost = 6656 and 226656,
    RodofAges = 6657 and 226657,
    BamisCinder = 6660,
    IcebornGauntlet = 6662 and 226662,
    TurboChemtank = 6664 and 226664,
    JakShoTheProtean = 6665 and 226665,
    RadiantVirtue = 6667 and 226667,
    Noonquiver = 6670,
    Galeforce = 6671 and 6671,
    KrakenSlayer = 6672 and 6672,
    ImmortalShieldbow = 6673 and 6673,
    NavoriQuickblades = 6675 and 6675,
    TheCollector = 6676 and 6676,
    Rageknife = 6677,
    DuskbladeofDraktharr = 6691 and 226691,
    Eclipse = 6692 and 226692,
    ProwlersClaw = 6693 and 226693,
    SeryldasGrudge = 6694 and 226694,
    SerpentsFang = 6695 and 226695,
    AxiomArc = 6696 and 226696,
    SandshrikesClaw = 7000,
    Syzygy = 7001 and 227001,
    DraktharrsShadowcarver = 7002 and 227002,
    FrozenFist = 7005 and 227005,
    Typhoon = 7006 and 227006,
    IcathiasCurse = 7009 and 227009,
    Vespertide = 7010 and 227010,
    UpgradedAeropack = 7011 and 227011,
    LiandrysLament = 7012 and 227012,
    EyeofLuden = 7013 and 227013,
    EternalWinter = 7014 and 227014,
    CeaselessHunger = 7015 and 227015,
    Dreamshatter = 7016 and 227016,
    Deicide = 7017 and 227017,
    InfinityForce = 7018 and 227018,
    ReliquaryoftheGoldenDawn = 7019 and 227019,
    ShurelyasRequiem = 7020 and 227020,
    Starcaster = 7021 and 227021,
    Equinox = 7023 and 227023,
    Caesura = 7024 and 227024,
    Leviathan = 7025 and 227025,
    TheUnspokenParasite = 7026 and 227026,
    PrimordialDawn = 7027 and 227027,
    InfiniteConvergence = 7028 and 227028,
    YoumuusWake = 7029 and 227029,
    SeethingSorrow = 7030 and 227030,
    EdgeofFinality = 7031 and 227031,
    Flicker = 7032 and 227032,
    CryoftheShriekingCity = 7033 and 227033,
    GangplankPlaceholder = 7050,
    AnathemasChains = 8001 and 228001,
    AbyssalMask = 8020 and 228020,
    ...
    if elevel >= 1 then
      ...
      if Buff:HasBuff(args.source, "KayleE") then
        ...
        if args.Target.type == Obj_AI_Camp then
          eActiveBonusDmg = math_max(eActiveBonusDmg, math_min(400, eActiveBonusDmg))
        end
...
--[[       if args.TargetIsMinion then
  ...
  ["Caitlyn"] = function(args) --Caitlyn headshot
    if Buff:HasBuff(args.source, "caitlynpassivedriver") then
      local modCrit = 1.421875 + (Item:HasItem(args.source, ItemID.InfinityEdge) and 0.365625 or 0) --1.3125 or 131.25% = 75% * standard critical damage factor
      if args.TargetIsMinion then
        local unitLevel = args.source.levelData.lvl
  ...
  ["KSante"] = function(args) --KSanteMark?
    ...
    if Buff:HasBuff(args.Target, "KSantePMark") then
      ...
      if Buff:HasBuff(args.source, "KSanteRTransform") then
        --local allOutDamageMod =  0.35 + (0.20 * math_floor(args.source.bonusArmor/100)) + (0.20 * math_floor(args.source.bonusMagicResist/100)) --removed 13.20
        args.RawPhysical = args.RawPhysical --* allOutDamageMod
        args.CalculatedTrue = args.CalculatedTrue + ((5 + 15 / 17 * (level - 1)) + ({1.00, 1.33, 1.66, 2.00})[hplvl]/100 * args.Target.maxHealth) --* allOutDamageMod
      else
...
local SpellDamageTable = {
  ...
  ["Akali"] = {
    ...
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({60, 130, 200})[level] + (0.30 * source.ap) * (0.0286 * (math_min(GetPercentMissingHP(target), 70))) end},
  },
  ...
  ["Amumu"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({7, 7, 7, 7, 7})[level] + (({0.5, 0.625, 0.75, 0.875, 1})[level]/100 + (0.25 * math_floor(source.ap / 100)) * target.maxHealth) end},
  ...
  ["AurelionSol"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return (3.75+6.25/17*(source.levelData.lvl-1))+({1.875, 3.125, 4.375, 5.625, 6.875})[level] + 0.075 * source.ap end}, -- per tick
    {Slot = "Q", Stage = 2, DamageType = 2, Damage = function(source, target, level) local starduststacks = GotBuff(target, "AurelionSolPassive"); return (20+10/17*(source.levelData.lvl-1))+({40, 50, 60, 70, 80})[level] + 0.35 * source.ap + (((3.1/100)*starduststacks) * target.maxHealth) end}, -- bonus damage
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({2.5, 3.75, 5, 6.25, 7.5})[level] + 0.0625 * source.ap end}, --per tick    damage to non-epic monster targets @ 5% (+ 2.6% Stardust stacks) of their maximum health are also executed
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 250, 350})[level] + 0.65 * source.ap end},
    ...
    {Slot = "R", Stage = 3, DamageType = 2, Damage = function(source, target, level) return ({150, 250, 350})[level] + 0.60 * source.ap end}, --AOE damage on empowered
  },
  ...
  ["Azir"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level)
      ...
      local wDmg = ({0, 0, 0, 0, 0 ,0 ,0 ,0, 0, 2, 7, 12, 17, 32, 47, 62, 77, 92})(azirLevel)
      return wDmg + ({50, 67, 84, 101, 118})[level] + 0.60 * source.ap end},
  ...
  ["Caitlyn"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({300, 525, 750})[level] + (2.00 * source.bonusDamage) * (1 + (math_min(source.critChance, 1) * .35)) end}, -- was 0-25% based on every 10% crit
  },
  ...
  ["Janna"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 110, 140, 170, 200})[level] + 0.60 * source.ap end},  --rip movespeed janna
  },
  ...
  ["Jinx"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) local dmg = (({32.5, 47.5, 62.5})[level] + (0.165 * source.bonusDamage) * (1.10 + (0.06 * math_min(math_floor(target.distance / 100),15)))) + (({25, 30, 35})[level] / 100 * GetMissingHP(target)); return dmg end}, --Inital hit damage
    {Slot = "R", Stage = 2, DamageType = 1, Damage = function(source, target, level) local dmg = (({26, 38, 50})[level] + (0.135 * source.bonusDamage) * (1.10 + (0.06 * math_min(math_floor(target.distance / 100),15)))) + (({20, 24, 28})[level] / 100 * GetMissingHP(target)); if target.type == Obj_AI_Camp then return math_min(1200, dmg) end; return dmg end}, --AOE splash damage
  },
    ...
    {Slot = "W", Stage = 2, DamageType = 2, Damage = function(source, target, level)
      ...
      if PlasmaStacks >=1 then
        ...
        if PlasmaStacks == 3 or (EvolvedW and PlasmaStacks == 2) then
          bonusdmg = (0.15 + (0.06 * math_floor(source.ap / 100))) * GetMissingHP(target);
          if target.type == Obj_AI_Camp then
            bonusdmg = math_min(400, bonusdmg)
          end;
          dmg = dmg + bonusdmg
        end;
...
--[[         if table_contains(Monstertable, monsterName) and epicMonster[monsterName].epicMonster then --epicMonster[monsterName] then -- table_contains(epicMonster, monsterName)
  ...
  ["Kayle"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level)
      ...
      local eActiveBonusDmg = (({8, 8.5, 9, 9.5, 10})[level]/100 + 0.015*source.ap) * GetMissingHP(target)
      --({8, 8.5, 9, 9.5, 10})[level]/100 + (1.5/100 * math_floor(source.ap/100)) * GetMissingHP(target)
  ...
  ["KogMaw"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return (({100, 140, 180})[level] + 0.65 * source.bonusDamage + 0.35 * source.ap) * (GetPercentHP(target) < 40 and 2) or (1+math_min(0.833 * GetPercentMissingHP(target)/100, .50)) end},
  },
  ...
  ["KSante"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({30, 60, 90, 120, 150})[level] + (0.40 * source.totalDamage) + (0.30 * source.bonusArmor) + (0.30 * source.bonusMagicResist) end},
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level)
      ...
      local dmg = ({20, 40, 60, 80, 100})[level] + (0.50 * source.totalDamage) + (0.30 * source.bonusArmor) + (0.30 * source.bonusMagicResist) + ((({6, 7, 8, 9, 10})[level]/100) * target.maxHealth)
  ...
  ["Naafiri"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({30, 45, 60, 75, 90})[level] + 0.20 * source.bonusDamage end},
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({100, 150, 200, 250, 300})[level] + 1.30 * source.bonusDamage end}, --dash + aoe flurry
  ...
  ["Rammus"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({100, 125, 150, 175, 200})[level] + 1.00 * source.ap end},
  ...
  ["Varus"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({7, 8, 9, 10, 11})[level] + 0.35 * source.ap end}, --non per stack
    {Slot = "W", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ((({3, 3.5, 4, 4.5, 5})[level] / 100) + 0.015 * math_floor(source.ap/100)) * target.maxHealth end}, -- per stack
  ...
  ["Vayne"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 3, Damage = function(source, target, level) return math_max(({50, 65, 80, 95, 110})[level], (({6, 7, 8, 9, 10})[level] / 100) * target.maxHealth) end},
  ...
  ["Viego"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return (((({12, 16, 20})[level] / 100) + (0.05 * math_floor(source.bonusDamage / 100))) * (GetPercentMissingHP(target))) end},
  ...
  ["Yorick"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return math_max(({70, 105, 140, 175, 210})[level] + (0.7 * source.ap), 0.15 * target.health) end},
  },
