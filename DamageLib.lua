local Version = 0.01
    ...
    local Files = {
        Lua = {
            Path = COMMON_PATH,
            Name = "DamageLib.lua",
            Url = "https://raw.githubusercontent.com/Pussykate/GoS/master/DamageLib.lua"

        },
        Version = {
            Path = COMMON_PATH,
            Name = "DamageLib.version",
            Url = "https://raw.githubusercontent.com/Pussykate/GoS/master/DamageLib.version"
        }	
    }
...
local DamageLibTable = {
  ...
  ["Janna"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({55, 90, 125, 160, 195})[level] + 0.5 * source.ap + (({0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35})[myHero.levelData.lvl] * source.ms) end},
  },
  ...
  ["Kaisa"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({45, 61, 77, 94, 110})[level] + 0.25 * source.ap + 0.35 * source.bonusDamage end},	
  ...
  ["Sejuani"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({40, 90, 140, 190, 240})[level] + 0.6 * source.ap end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 250, 350})[level] + 0.8 * source.ap end},
  },
