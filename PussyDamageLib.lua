...
local DamageLibTable = {
  ...
  ["Garen"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({14, 18, 22, 26, 30})[level] + ({36, 37, 38, 39, 40})[level] / 100 * source.totalDamage end},
  ...
  ["Gragas"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({20, 50, 80, 110, 140})[level] + 0.5 * source.ap + 0.08 * (target.maxHealth - target.health) end},
  ...
  ["Kayle"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 115, 160, 205, 250})[level] + 0.6 * source.bonusDamage + 0.5 * source.ap end},
  ...
  ["Kalista"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return (({5, 7.5, 10, 12.5, 15})[level] / 100) * target.maxHealth end},
  ...
  ["Kayn"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({60, 80, 100, 120, 140})[level] + 0.65 * source.bonusDamage end},
  ...
  ["Maokai"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({50, 75, 100, 125, 150})[level] + 0.4 * source.ap  end},
  ...
  ["Pantheon"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({75, 115, 155, 195, 235})[level] + source.bonusDamage end},
  ...
  ["Qiyana"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({80, 100, 120, 140, 160})[level] + 0.9 * source.bonusDamage end},
    {Slot = "Q", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({128, 160, 192, 224, 256})[level] + 1.44 * source.bonusDamage end},--Terrain Damage	
  ...
  ["Sejuani"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 120, 160, 200, 240})[level] + 0.4 * source.ap end},
  ...
  ["Shaco"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({55, 80, 105, 130, 155})[level] + ({60, 75, 90, 105, 120})[level] / 100 * source.bonusDamage + 0.75 * source.ap + 0.5 * (target.maxHealth - target.health) end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({200, 300, 400})[level] + source.ap end},
  },
  ...
  ["Viktor"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({50, 65, 80, 95, 110})[level] + 0.4 * source.ap end},
    ...
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({130, 210, 290})[level] + 0.85 * source.ap end},--Per Tick
  },
  ...
  ["Warwick"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return (({6, 6.5, 7, 7.5, 8})[level] / 100  * target.maxHealth) + source.ap + 1.2 * source.totalDamage end},
  ...
  ["XinZhao"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({20, 25, 30, 35, 40})[level] + 0.4 * source.bonusDamage end},
