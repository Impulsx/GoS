...
local DamageLibTable = {
  ...
  ["Garen"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({8, 12, 16, 20, 24})[level] + (0.471 + 0.471 * source.levelData.lvl) + ({32, 34, 36, 38, 40})[level] / 100 * source.totalDamage end},
