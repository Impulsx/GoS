...
function LoadScript()
	...
	WspellData = {speed = WData.Speed, range = WData.Range, delay = WData.Delay, radius = WData.Radius, collision = {nil}, type = "linear"}
	...
	EspellData = {speed = EData.Speed, range = EData.Range, delay = EData.Delay, radius = EData.Radius, collision = {nil}, type = "linear"}
...
function CastGGPredW(unit)
	local WPrediction = GGPrediction:SpellPrediction({WData.Delay, Radius = WData.Radius, Range = WData.Range, Speed = WData.Speed, Collision = false, Type = GGPrediction.SPELLTYPE_LINE})
...
function CastGGPredE(unit)
	local EPrediction = GGPrediction:SpellPrediction({EData.Delay, Radius = EData.Radius, Range = EData.Range, Speed = EData.Speed, Collision = false, Type = GGPrediction.SPELLTYPE_LINE})
