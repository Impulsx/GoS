...
function Annie:Menu()
    self.Anniemenu = MenuElement({type = MENU, id = "Annie", name = "Annie", leftIcon = HeroIcon})
    ...
    self.AnnieMenu:MenuElement({type = MENU, id = "AutoLevel", name =  myHero.charName.." AutoLevel Spells"})
        ...
        self.AnnieMenu.AutoLevel:MenuElement({id = "LvL", name = "AutoLevel start -->", value = 5, min = 1, max = 6, step = 1})
        self.AnnieMenu.AutoLevel:MenuElement({id = "delay", name = "Delay for Level up", value = 2, min = 0 , max = 10, step = 0.5, identifier = "sec"})
        self.AnnieMenu.AutoLevel:MenuElement({id = "Order", name = "Skill Order", value = 3, drop = {"QWE", "WEQ", "EQW", "EWQ", "WQE", "QEW"}})
