...
local DetectedMissiles = {}; DetectedSpells = {}; Target = nil; Timer = 0
    ...
    self.Menu:MenuElement({id = "AutoMode", name = "Auto", type = MENU})
        ...
        self.Menu.AutoMode:MenuElement({id = "UseEFinish", name = "[E]+ AA To KS A Single Target", value = false, leftIcon = EIcon})
    ...
    self.Menu:MenuElement({type = MENU, id = "Pred", name = "Prediction Mode"})
        self.Menu.Pred:MenuElement({id = "Predspace", name = "After change Prediction Type press 2xF6", type = SPACE})
