...
local DamageLibTable = {
	...
	["LeeSin"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({100, 150, 200, 250, 300})[level] + 2 * source.bonusDamage + 0.01 * (target.maxHealth - target.health) end},
